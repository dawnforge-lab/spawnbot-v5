...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Spawnbot console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Spawnbot",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Spawnbot",
		Exiting:            "Exiting Spawnbot...",
		DocUrl:             "https://docs.spawnbot.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Spawnbot 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Spawnbot",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Spawnbot",
		Exiting:            "正在退出 Spawnbot...",
		DocUrl:             "https://docs.spawnbot.io/zh-Hans/docs/",
	},
}
