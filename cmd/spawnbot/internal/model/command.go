...
Examples:
  spawnbot model                    # Show current default model
  spawnbot model gpt-5.2           # Set gpt-5.2 as default
  spawnbot model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  spawnbot model local-model       # Set local VLLM server as default
