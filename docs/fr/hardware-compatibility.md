...
# 🖥️ Spawnbot Liste de compatibilité matérielle

Spawnbot fonctionne sur pratiquement n'importe quel appareil Linux. Cette page répertorie les puces, produits et cartes de développement vérifiés.
...
Produits grand public, routeurs et appareils industriels testés avec Spawnbot.
...
Tout téléphone Android ARM64 (2015+) avec 1 Go+ de RAM. Installez [Termux](https://github.com/termux/termux-app), utilisez `proot` pour exécuter Spawnbot.
...
wget https://github.com/dawnforge-lab/spawnbot-v5/releases/latest/download/spawnbot_Linux_arm64.tar.gz
tar xzf spawnbot_Linux_arm64.tar.gz

# 2. Initialiser
./spawnbot onboard

# 3. Tester
./spawnbot agent -m "Hello, what board am I running on?"
```
