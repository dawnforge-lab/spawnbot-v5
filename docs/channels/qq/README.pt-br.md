...
O Spawnbot oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do Spawnbot
4. Execute `spawnbot gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do Spawnbot
5. Execute `spawnbot gateway` para iniciar o serviço
