...
Spawnbot provides QQ support via the official Bot API from the QQ Open Platform.
...
3. Fill in the credentials in the Spawnbot configuration file
4. Run `spawnbot gateway` to start the service
...
4. Fill in the credentials in the Spawnbot configuration file
5. Run `spawnbot gateway` to start the service
