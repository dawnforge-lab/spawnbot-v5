...
Spawnbot hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Spawnbot
4. Chạy `spawnbot gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Spawnbot
5. Chạy `spawnbot gateway` để khởi động dịch vụ
