...
Spawnbot prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration Spawnbot
4. Exécuter `spawnbot gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration Spawnbot
5. Exécuter `spawnbot gateway` pour démarrer le service
