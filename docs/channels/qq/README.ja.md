...
Spawnbot は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Spawnbot 設定ファイルに認証情報を入力する
4. `spawnbot gateway` を実行してサービスを起動する
...
4. Spawnbot 設定ファイルに認証情報を入力する
5. `spawnbot gateway` を実行してサービスを起動する
