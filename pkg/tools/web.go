...
const (
	...
	userAgentHonest = "spawnbot/%s (+https://github.com/dawnforge-lab/spawnbot-v5; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(ctx context.Context, query string, count int) (string, error) {
	...
	// Format results in standard Spawnbot format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies spawnbot, which some
