...
func (cb *ContextBuilder) getIdentity() string {
	...
	fmt.Fprintf(&sb, "# spawnbot (%s)\n\nAll file paths are relative to the workspace root. Use `GOALS.md`, `skills/weather/SKILL.md`, `memory/MEMORY.md` etc.\n", version)
...
- await_event: pause until a named event fires (see event argument). Another turn can resume you by calling fire_event with the same name. If you also supply after_ms, that acts as a fallback timeout.
