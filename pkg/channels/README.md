# Spawnbot Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/spawnbot/internal/gateway/`
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom Spawnbot native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
