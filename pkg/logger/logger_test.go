...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/spawnbot_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("SPAWNBOT_LOG_FILE", tmpFile)
	defer os.Unsetenv("SPAWNBOT_LOG_FILE")
	...
	os.Setenv("SPAWNBOT_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
