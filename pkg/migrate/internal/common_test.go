...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.spawnbot")
	assert.Equal(t, "/home/user/.spawnbot/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.spawnbot/workspace/file.txt", "/home/user/.spawnbot")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".spawnbot"), result)
}
