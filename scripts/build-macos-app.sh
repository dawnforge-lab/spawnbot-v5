#!/bin/bash
# Build macOS .app bundle for Spawnbot Launcher
...
APP_NAME="Spawnbot Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="spawnbot-launcher"
...
if [ -f "./build/spawnbot" ]; then
    cp "./build/spawnbot" "${APP_MACOS}/"
else
    echo "Error: ./build/spawnbot not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>spawnbot-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.spawnbot.launcher</string>
